...
| Reviewer | amy |
| Date | 2026-04-13 |
| Artifact Reviewed | `.harnesskit/harness/evaluations/EV-20260413-baseline-expiration-policy.md` |
| Phase | review |
| Version | 1.0 |
...
| Contract Path | `.harnesskit/harness/contracts/completed/HC-20260413-baseline-expiration-policy.md` |
| Risk Level | medium |
...
| --- | --- | --- |
| MH-01 - Baseline entries have expiration dates | PASS | `.harnesskit/harness/baselines/current.yaml` has `expires_at` on all four accepted entries. |

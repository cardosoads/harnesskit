...
| Evaluator | amy |
| Risk | medium |
| Source Spec | `.harnesskit/harness/contracts/completed/HC-20260413-baseline-expiration-policy.md` |
...
- `.harnesskit/scripts/harness_selftest.py` - self-test implementation.
- `.harnesskit/scripts/harness-selftest.sh` - wrapper script.
- `.harnesskit/scripts/validate.sh` - required-file registration.
- `.harnesskit/harness/sensors.yaml` - required sensor registration.
- `.harnesskit/harness/evaluations/EV-20260413-harness-doctor-selftest.md` -
  evaluation evidence.
...
**Observable truth:** `.harnesskit/scripts/harness_selftest.py` exists and can be
executed with Python.

**Verification:**
- `python3 .harnesskit/scripts/harness_selftest.py`
...
**Observable truth:** `.harnesskit/scripts/harness-selftest.sh` exists and invokes
the Python self-test.

**Verification:**
- `bash .harnesskit/scripts/harness-selftest.sh`
...
**Verification:**
- Static review of `.harnesskit/scripts/harness_selftest.py`.
...
**Verification:**
- `bash .harnesskit/scripts/harness-evaluate.sh --contract .harnesskit/harness/contracts/completed/HC-20260413-harness-doctor-selftest.md`
...
- **harness-evaluate-contract**: `bash .harnesskit/scripts/harness-evaluate.sh --contract .harnesskit/harness/contracts/completed/HC-20260413-harness-doctor-selftest.md`

### Recommended

- **python-compile**: `python3 -m py_compile .harnesskit/scripts/harness_doctor.py .harnesskit/scripts/harness_evaluate.py .harnesskit/scripts/harness_selftest.py`
...
Amy review artifact:
`.harnesskit/artifacts/review/harness-doctor-selftest-review.md`

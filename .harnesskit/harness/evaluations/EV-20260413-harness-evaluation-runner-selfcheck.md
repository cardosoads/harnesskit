...
options:
  ...
  --sensor-group SENSOR_GROUP
                        Sensor group from .harnesskit/harness/sensors.yaml
  --output OUTPUT       Evaluation output path. Defaults to
                        .harnesskit/harness/evaluations/<evaluation-id>.md
  --include-recommended

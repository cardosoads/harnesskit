# Harnesskit Constitution

The principles below are non-negotiable. Every agent, workflow, and decision within Harnesskit must respect them. Violations must be blocked by the orchestrator.

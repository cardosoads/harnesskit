# Harness Evaluation: EV-20260413-init-wizard-publish-prep

| Field | Value |
| --- | --- |
| Project | overharness-dev |
| Evaluation | EV-20260413-init-wizard-publish-prep |
| Contract | HC-20260413-init-wizard-publish-prep |
| Contract Path | `/Users/wesleycardoso/Wesley/Harness/overharness-dev/.overharness/harness/contracts/completed/HC-20260413-init-wizard-publish-prep.md` |
| Date | 2026-04-13 |
...
**Expected truth:** Explicit init remains non-interactive
...
**Expected truth:** Yes mode works without TTY prompts
...
**Expected truth:** Interactive code path exists without dependencies
...
**Expected truth:** npm usage is documented
...
**Expected truth:** Package dry run remains clean
...
**Expected truth:** Validation protects README/publish prep
...
... output truncated (89 more lines)
```
...
[BASELINE] feedforward/artifact_placeholder: .overharness/artifacts/architecture/feature-design.md has unresolved template/TODO markers at lines 239, 303, 304, 305, 319 [baseline: baseline-feature-design-template-markers, expires: 2026-05-13] (.overharness/artifacts/architecture/feature-design.md)
...
[BASELINE] feedforward/implementation_report_missing_harness: .overharness/artifacts/implementation/bf-setup-report.md has no Harness Contract section [baseline: baseline-bf-report-no-harness-section, expires: 2026-05-13] (.overharness/artifacts/implementation/bf-setup-report.md)
```
...
**Command:** `bash .overharness/scripts/harness-selftest.sh`
...
### overharness-cli-status - PASS

**Command:** `node bin/overharness.mjs status`
...
### overharness-cli-next - PASS

**Command:** `node bin/overharness.mjs next`
...
Recommended action:
  Create the next Harness contract for the feature or improvement you want.
  Run: overharness contract "describe the work unit"
...
```text
> overharness@0.1.0 test
> bash .overharness/scripts/validate.sh && bash .overharness/scripts/harness-selftest.sh
...
Validating YAML files...
  ...
  ✓ core/agents/penny.agent.yaml
  ✓ core/agents/raj.agent.yaml
... output truncated (103 more lines)
```
...
```text
> overharness@0.1.0 pack:check
> npm pack --dry-run --json

[
  {
    "id": "overharness@0.1.0",
    "name": "overharness",
    "version": "0.1.0",
    "size": 154700,
    "unpackedSize": 568775,
    "shasum": "94bfe714e14a432a6340a7ed65d12c6de863f24d",
    "integrity": "sha512-Xovynl1CPQMo0DrWqvcYYsKG9vh1Di0YqiBBhRmslbGOCnfvaKEPuFm6alBqlueEWhgqmaMZiQrC8axW+bHQhQ==",
    "filename": "overharness-0.1.0.tgz",
    "files": [
      {
        "path": ".claude/commands/overharness-contract.md",
        "size": 291,
        "mode": 420

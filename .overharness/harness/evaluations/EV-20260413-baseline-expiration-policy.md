# Harness Evaluation: EV-20260413-baseline-expiration-policy

| Field | Value |
| --- | --- |
| Project | overharness-dev |
| Evaluation | EV-20260413-baseline-expiration-policy |
| Contract | HC-20260413-baseline-expiration-policy |
| Contract Path | `/Users/wesleycardoso/Wesley/Harness/overharness-dev/.overharness/harness/contracts/completed/HC-20260413-baseline-expiration-policy.md` |
| Date | 2026-04-13 |
...
**Expected truth:** Baseline entries have expiration dates
...
**Expected truth:** Accepted baselines expose expiration metadata
...
**Expected truth:** Missing or invalid expiration does not accept the baseline
...
**Expected truth:** Expired baseline does not accept the finding
...
**Expected truth:** Errors still cannot be downgraded

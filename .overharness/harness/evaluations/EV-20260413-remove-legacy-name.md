...
| Contract Path | `/Users/wesleycardoso/Wesley/Harness/overharness-dev/.overharness/harness/contracts/completed/HC-20260413-remove-legacy-name.md` |
| Date | 2026-04-13 |
...
**Expected truth:** CLI uses OverHarness-only paths

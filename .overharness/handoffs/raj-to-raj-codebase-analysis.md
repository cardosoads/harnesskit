...
Codebase analysis completed for overharness-dev. The project is a configuration-driven AI agent orchestration framework with 7 agents, 10 workflow directories, 3 team presets, and a comprehensive engine (state machine, workflow engine, spec loader, context monitor).

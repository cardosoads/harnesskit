...
6. Read `.overharness/harness/HARNESS.md` and `.overharness/harness/sensors.yaml`
...
2. Load `.overharness/core/agents/leslie.agent.yaml`
3. Execute `.overharness/core/workflows/harness-contract/workflow.yaml`
4. Save the contract in `.overharness/harness/contracts/active/`
...
6. Include:
   ...
   - applicable sensors from `.overharness/harness/sensors.yaml`

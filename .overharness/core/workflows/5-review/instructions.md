...
If `.overharness/harness/contracts/active/`, `.overharness/harness/contracts/completed/`,
or `.overharness/harness/evaluations/` contain files relevant to the selected
...
6. **Harness connection** for implementation artifacts:
   ...
   - sensor evidence matches the sensors configured in `.overharness/harness/sensors.yaml`

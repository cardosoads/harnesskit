...
Use `bash .overspec/scripts/harness-doctor.sh` para checar prontidao de
...
Use `.overspec/harness/baselines/current.yaml` para documentar avisos conhecidos
...
Use `bash .overspec/scripts/harness-evaluate.sh` para executar os sensores de
...
bash .overspec/scripts/harness-evaluate.sh --contract .overspec/harness/contracts/active/HC-YYYYMMDD-slug.md
bash .overspec/scripts/harness-evaluate.sh --include-recommended
```

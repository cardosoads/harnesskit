...
| Source Review | `.overspec/artifacts/review/overharness-publish-review.md` |
| Status | blocked-on-npm-auth |

## Work Unit

Rename the public product/package surface from OverSpec to OverHarness, keep
internal `.overspec/` project structure compatible, prepare the npm package for
`overharness`, and push the repository to
...
- Add the `overharness` CLI binary and keep `overspec` as a compatibility alias.
...
Evaluation artifact:
`.overspec/harness/evaluations/EV-20260413-overharness-publish.md`

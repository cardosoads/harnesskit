...
| Evaluator | amy |
| Risk | medium |
| Source Spec | `.overspec/harness/contracts/completed/HC-20260413-baseline-expiration-policy.md` |
...
- `.overspec/scripts/harness_selftest.py` - self-test implementation.
- `.overspec/scripts/harness-selftest.sh` - wrapper script.
- `.overspec/scripts/validate.sh` - required-file registration.
- `.overspec/harness/sensors.yaml` - required sensor registration.
- `.overspec/harness/evaluations/EV-20260413-harness-doctor-selftest.md` -
  evaluation evidence.
...
**Observable truth:** `.overspec/scripts/harness_selftest.py` exists and can be
executed with Python.

**Verification:**
- `python3 .overspec/scripts/harness_selftest.py`
...
**Observable truth:** `.overspec/scripts/harness-selftest.sh` exists and invokes
the Python self-test.

**Verification:**
- `bash .overspec/scripts/harness-selftest.sh`
...
**Verification:**
- Static review of `.overspec/scripts/harness_selftest.py`.
...
**Verification:**
- `bash .overspec/scripts/harness-evaluate.sh --contract .overspec/harness/contracts/completed/HC-20260413-harness-doctor-selftest.md`
...
- **harness-evaluate-contract**: `bash .overspec/scripts/harness-evaluate.sh --contract .overspec/harness/contracts/completed/HC-20260413-harness-doctor-selftest.md`

### Recommended

- **python-compile**: `python3 -m py_compile .overspec/scripts/harness_doctor.py .overspec/scripts/harness_evaluate.py .overspec/scripts/harness_selftest.py`
...
Amy review artifact:
`.overspec/artifacts/review/harness-doctor-selftest-review.md`

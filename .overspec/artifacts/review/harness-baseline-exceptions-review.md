...
| Reviewer | amy |
| Date | 2026-04-13 |
| Artifact Reviewed | `.overspec/harness/evaluations/EV-20260413-harness-baseline-exceptions.md` |
| Phase | review |
| Version | 1.0 |
...
| Contract Path | `.overspec/harness/contracts/active/HC-20260413-harness-baseline-exceptions.md` |
| Risk Level | medium |
...
| --- | --- | --- |
| MH-01 - Baseline file exists and documents current warnings | PASS | `.overspec/harness/baselines/current.yaml` exists and lists the four current warning codes. |

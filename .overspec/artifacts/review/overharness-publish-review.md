...
Date: 2026-04-13
Contract: `.overspec/harness/contracts/active/HC-20260413-overharness-publish.md`
...
CLI binary. The old `overspec` bin remains as a compatibility alias pointing to
...
OverHarness name. The internal `.overspec/` directory remains unchanged for
compatibility.
...
- `npm run test` passed.
- `bash .overspec/scripts/harness-doctor.sh` passed with 0 errors and 0
